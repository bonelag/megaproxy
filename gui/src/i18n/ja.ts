...
export const ja: Record<TKey, string> = {
  ...
  "pws.headersConfigured": "このプロバイダーには既にカスタムヘッダーが設定されています。プライバシーのため値は表示されません。このセクションを編集して保存するとセット全体が置き換わります。",
  "pws.headersReplaceWarn": "保存すると、このプロバイダーのカスタムヘッダーはすべて下の入力内容で置き換わります。",
  "pws.clearHeaders": "クリア",
  "pws.removeHeader": "ヘッダーを削除",
  ...
  "modal.userAgent": "カスタム User-Agent",
  "modal.userAgentPlaceholder": "claude-cli/2.1.220 (external, cli)",
  "modal.userAgentHint": "空欄のままにするとデフォルトの User-Agent を使います。",
  "modal.customHeaders": "カスタムヘッダー",
  "modal.customHeadersHint": "このプロバイダーへ送る任意の HTTP ヘッダーを追加します。",
  "modal.headerName": "ヘッダー名",
  "modal.headerValue": "値",
  "modal.addHeader": "追加",
  "modal.headersInvalid": "保存前にカスタムヘッダーを修正してください（空の名前、重複、無効な文字）。",
  "modal.headersUserAgentRow": "User-Agent はヘッダー行ではなく「カスタム User-Agent」欄に入れてください。",
  "modal.adding": "追加中…",
  ...
  "claude.workspace.models": "モデル",
  "claude.customModel.configFile": "設定ファイル: {path}",
  "claude.customModel.selectEndpoint": "エンドポイントを選択",
  "claude.customModel.customUrlOption": "カスタム URL...",
  "claude.customModel.current": "現在",
  "claude.customModel.currentEmpty": "(settings.json に設定されていません)",
  "claude.customModel.apiKey": "API キー",
  "claude.customModel.default": "(デフォルト)",
  "claude.customModel.customKeyOption": "カスタム API キー...",
  "claude.customModel.apiKeyPlaceholder": "sk-... または opencodex-proxy",
  ...
  "claude.customModel.customOption": "カスタムモデルオプション",
  "claude.customModel.selectModel": "モデルを選択",
  "claude.customModel.clearValue": "値をクリア",
  "claude.customModel.saveBtn": "settings.json に保存",
  "claude.customModel.saving": "保存中...",
  "claude.customModel.savedSuccess": "Claude Code の settings.json にモデル設定を正常に保存しました！",
  "claude.customModel.modalTitle": "{target} のモデルを選択",
  "claude.customModel.searchPlaceholder": "モデルを検索 (例: opus, gpt-5, deepseek)...",
  "claude.customModel.noModelsFound": "一致するモデルが見つかりません。",
  ...
  "claudeDesktop.section.profileIo": "インポート / エクスポート",
  "claudeDesktop.chatTab": "チャットタブ",
  "claudeDesktop.chatTabDesc": "Claude Desktop のチャットタブを表示したままにします。オフにすると適用後は Cowork と Code だけが残ります。",
  "claudeDesktop.supports1mLabel": "1M コンテキスト対応",
  "claudeDesktop.supports1mAuto": "このモデルは 1M ウィンドウを報告するため、既定でオンです。",
  "claudeDesktop.supports1mManual": "モデルが実際に 1M ウィンドウを受け付ける場合のみオンにしてください。",
  "claudeDesktop.prefer1mLabel": "既定で 1M を使う",
  "claudeDesktop.prefer1mDesc": "Claude Desktop がこのモデルの 1M 版を先に選びます。",
  "claudeDesktop.prefer1mRequires": "先に 1M コンテキスト対応をオンにしてください。",
  "claudeDesktop.prefer1mChip": "1M 既定",
  "claudeDesktop.hiddenUnavailable": "利用できないモデル {count} 件を非表示にしました。プロバイダーを有効にすると割り当てられます。",
  "claudeDesktop.profileIoHint": "この Desktop プロファイルを JSON として別のマシンへ移せます。インポートは下書きを読み込むだけなので保存が必要です。",
  ...
  "nav.chat": "チャット",
  "chat.threadLabel": "会話",
  "chat.historyLabel": "チャット履歴",
  "chat.newChat": "新しいチャット",
  "chat.noHistory": "保存されたチャットはまだありません。",
  "chat.untitled": "新しいチャット",
  "chat.renameLabel": "会話のタイトル",
  "chat.renameSave": "タイトルを保存",
  "chat.renameCancel": "キャンセル",
  "chat.deleteChat": "チャットを削除",
  "chat.clearAll": "履歴を消去",
  "chat.clearAllConfirm": "すべてのチャットを削除",
  "chat.model": "モデル",
  "chat.loadingModels": "モデルを読み込み中",
  "chat.modelsLoadFailed": "モデル一覧を読み込めませんでした",
  "chat.retry": "再試行",
  "chat.noModels": "利用できるモデルがありません。まずプロバイダーを追加するかモデルを有効にしてください。",
  "chat.systemPrompt": "システムプロンプト",
  "chat.systemPromptLabel": "この会話のシステムプロンプト",
  "chat.systemPromptPlaceholder": "毎ターンの前に送信される任意の指示。",
  "chat.emptyTitle": "会話を始める",
  "chat.emptyBody": "接続済みプロバイダーのすべての AI モデルと対話できるシンプルなチャット画面です。モデルを選んで始めましょう。",
  "chat.roleYou": "あなた",
  "chat.roleAssistant": "アシスタント",
  "chat.thinking": "思考中",
  "chat.stoppedFlag": "停止済み",
  "chat.copyMessage": "メッセージをコピー",
  "chat.copyCode": "コードをコピー",
  "chat.regenerate": "再生成",
  "chat.deleteFromHere": "ここから削除",
  "chat.dismissError": "閉じる",
  "chat.placeholder": "メッセージを送信…",
  "chat.noModelPlaceholder": "チャットするモデルを選択してください",
  "chat.inputLabel": "メッセージ",
  "chat.send": "送信",
  "chat.stop": "停止",
  "chat.sendHint": "Enter で送信 · Shift+Enter で改行 · 画像やテキストファイルを貼り付け／ドロップできます",
  "chat.attach": "ファイルを添付",
  "chat.attachTextOnlyHint": "テキストファイルを添付（このモデルは画像を読み取れません）",
  "chat.removeAttachment": "{name} を削除",
  "chat.attachUnsupported": "{name}: 対応していないファイル形式です",
  "chat.attachTooLarge": "{name}: {limit} を超えています",
  "chat.attachTooMany": "1 メッセージあたり最大 {limit} 個の添付ファイルです",
  "chat.attachReadFailed": "{name}: 読み取れませんでした",

  "chat.history": "履歴",
  "chat.recentChats": "最近のチャット",
  "chat.emptyChat": "空のチャット",
  "chat.noModelSelected": "モデルを選択",
  "chat.modelsPanelTitle": "モデル",
  "chat.modelsPanelSub": "接続済みプロバイダーのもののみ",
  "chat.modelSearchPlaceholder": "モデルまたはプロバイダーを検索…",
  "chat.modelSearchEmpty": "該当するモデルはありません。",
  "chat.modelsFilteredNote": "モデル一覧は接続済みプロバイダーから絞り込んでいます。",
  "chat.modeLabel": "応答モード",
  "chat.modeChat": "チャット",
  "chat.modeImage": "画像",
  "chat.modeImageSoon": "このタブでの画像生成はまだ利用できません。",
  "chat.effortLabel": "思考の深さ",
  "chat.effortNone": "思考なし",
  "chat.effortLow": "低",
  "chat.effortMedium": "中",
  "chat.effortHigh": "高",
  "chat.effortXhigh": "非常に高",
  "chat.effortMax": "最大",
