...
export const ru: Record<TKey, string> = {
  ...
  "pws.retry": "Повторить",
  "pws.fetchModels": "Загрузить модели",
  ...
  "pws.headersConfigured": "У этого провайдера уже настроены свои заголовки. Значения здесь не показываются из соображений конфиденциальности. Редактирование и сохранение этого раздела заменяет весь набор.",
  "pws.headersReplaceWarn": "Сохранение заменит все свои заголовки этого провайдера на введённые ниже.",
  "pws.clearHeaders": "Очистить",
  "pws.removeHeader": "Удалить заголовок",
  ...
  "modal.userAgent": "Свой User-Agent",
  "modal.userAgentPlaceholder": "claude-cli/2.1.220 (external, cli)",
  "modal.userAgentHint": "Оставьте пустым, чтобы использовать User-Agent по умолчанию.",
  "modal.customHeaders": "Свои заголовки",
  "modal.customHeadersHint": "Дополнительные HTTP-заголовки, отправляемые этому провайдеру.",
  "modal.headerName": "Имя заголовка",
  "modal.headerValue": "Значение",
  "modal.addHeader": "Добавить",
  "modal.headersInvalid": "Исправьте свои заголовки перед сохранением (пустые имена, дубликаты или недопустимые символы).",
  "modal.headersUserAgentRow": "Укажите User-Agent в поле «Свой User-Agent», а не в строке заголовка.",
  ...
  "claude.workspace.models": "Модели",
  "claude.customModel.configFile": "Файл конфигурации: {path}",
  "claude.customModel.selectEndpoint": "Выбрать эндпоинт",
  "claude.customModel.customUrlOption": "Пользовательский URL...",
  "claude.customModel.current": "Текущий",
  "claude.customModel.currentEmpty": "(Не задано в settings.json)",
  "claude.customModel.apiKey": "Ключ API",
  "claude.customModel.default": "(По умолчанию)",
  "claude.customModel.customKeyOption": "Пользовательский ключ API...",
  "claude.customModel.apiKeyPlaceholder": "sk-... или opencodex-proxy",
  ...
  "claude.customModel.customOption": "Параметр кастомной модели",
  "claude.customModel.selectModel": "Выбрать модель",
  "claude.customModel.clearValue": "Очистить значение",
  "claude.customModel.saveBtn": "Сохранить в settings.json",
  "claude.customModel.saving": "Сохранение...",
  "claude.customModel.savedSuccess": "Настройки моделей успешно сохранены в settings.json для Claude Code!",
  "claude.customModel.modalTitle": "Выбрать модель для {target}",
  "claude.customModel.searchPlaceholder": "Поиск моделей (напр., opus, gpt-5, deepseek)...",
  "claude.customModel.noModelsFound": "Подходящих моделей не найдено.",
  ...
  "claude.quickstart": "Как настроить",
  ...
  "claudeDesktop.section.general": "Общие",
  "claudeDesktop.section.profileIo": "Импорт / экспорт",
  "claudeDesktop.chatTab": "Вкладка «Чат»",
  "claudeDesktop.chatTabDesc": "Оставлять вкладку «Чат» в Claude Desktop видимой. Если выключить, после применения останутся только Cowork и Code.",
  "claudeDesktop.supports1mLabel": "Поддержка контекста 1M",
  "claudeDesktop.supports1mAuto": "Модель сообщает окно 1M, поэтому поддержка включена по умолчанию.",
  "claudeDesktop.supports1mManual": "Включайте только если модель действительно принимает окно 1M.",
  "claudeDesktop.prefer1mLabel": "Использовать 1M по умолчанию",
  "claudeDesktop.prefer1mDesc": "Claude Desktop сначала выбирает вариант этой модели с окном 1M.",
  "claudeDesktop.prefer1mRequires": "Сначала включите поддержку контекста 1M.",
  "claudeDesktop.prefer1mChip": "1M по умолчанию",
  "claudeDesktop.hiddenUnavailable": "Скрыто недоступных моделей: {count}. Включите провайдера, чтобы назначить их.",
  "claudeDesktop.profileIoHint": "Переносите этот профиль Desktop между машинами в виде JSON. Импорт загружает черновик, который ещё нужно сохранить.",
  ...
  // Chat tab
  "nav.chat": "Чат",
  "chat.threadLabel": "Диалог",
  "chat.historyLabel": "История чатов",
  "chat.newChat": "Новый чат",
  "chat.noHistory": "Сохранённых чатов пока нет.",
  "chat.untitled": "Новый чат",
  "chat.renameLabel": "Название диалога",
  "chat.renameSave": "Сохранить название",
  "chat.renameCancel": "Отмена",
  "chat.deleteChat": "Удалить чат",
  "chat.clearAll": "Очистить историю",
  "chat.clearAllConfirm": "Удалить все чаты",
  "chat.model": "Модель",
  "chat.loadingModels": "Загрузка моделей",
  "chat.modelsLoadFailed": "Не удалось загрузить список моделей",
  "chat.retry": "Повторить",
  "chat.noModels": "Нет доступных моделей. Сначала добавьте провайдера или включите модель.",
  "chat.systemPrompt": "Системный промпт",
  "chat.systemPromptLabel": "Системный промпт для этого диалога",
  "chat.systemPromptPlaceholder": "Необязательные инструкции, отправляемые перед каждым запросом.",
  "chat.emptyTitle": "Начните диалог",
  "chat.emptyBody": "Простой интерфейс чата для любой модели подключённых провайдеров. Выберите модель и начните общение.",
  "chat.roleYou": "Вы",
  "chat.roleAssistant": "Ассистент",
  "chat.thinking": "Думает",
  "chat.stoppedFlag": "остановлено",
  "chat.copyMessage": "Копировать сообщение",
  "chat.copyCode": "Копировать код",
  "chat.regenerate": "Сгенерировать заново",
  "chat.deleteFromHere": "Удалить отсюда",
  "chat.dismissError": "Скрыть",
  "chat.placeholder": "Отправить сообщение…",
  "chat.noModelPlaceholder": "Выберите модель, чтобы начать чат",
  "chat.inputLabel": "Сообщение",
  "chat.send": "Отправить",
  "chat.stop": "Стоп",
  "chat.sendHint": "Enter — отправить · Shift+Enter — новая строка · изображения и текстовые файлы можно вставить или перетащить",
  "chat.attach": "Прикрепить файлы",
  "chat.attachTextOnlyHint": "Прикрепить текстовые файлы (эта модель не читает изображения)",
  "chat.removeAttachment": "Удалить {name}",
  "chat.attachUnsupported": "{name}: неподдерживаемый тип файла",
  "chat.attachTooLarge": "{name}: больше, чем {limit}",
  "chat.attachTooMany": "Не более {limit} вложений в одном сообщении",
  "chat.attachReadFailed": "{name}: не удалось прочитать",

  "chat.history": "История",
  "chat.recentChats": "Недавние чаты",
  "chat.emptyChat": "Пустой чат",
  "chat.noModelSelected": "Выберите модель",
  "chat.modelsPanelTitle": "Модели",
  "chat.modelsPanelSub": "Только от подключённых провайдеров",
  "chat.modelSearchPlaceholder": "Поиск модели или провайдера…",
  "chat.modelSearchEmpty": "Нет моделей, соответствующих запросу.",
  "chat.modelsFilteredNote": "Список моделей формируется из подключённых провайдеров.",
  "chat.modeLabel": "Режим ответа",
  "chat.modeChat": "Чат",
  "chat.modeImage": "Изображение",
  "chat.modeImageSoon": "Генерация изображений на этой вкладке пока недоступна.",
  "chat.effortLabel": "Глубина размышлений",
  "chat.effortNone": "Без размышлений",
  "chat.effortLow": "Низкая",
  "chat.effortMedium": "Средняя",
  "chat.effortHigh": "Высокая",
  "chat.effortXhigh": "Очень высокая",
  "chat.effortMax": "Максимум",
  "chat.thinkingNow": "Думает…",
  "chat.thoughtProcess": "Ход размышлений",
};
