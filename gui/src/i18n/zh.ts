...
export const zh: Record<TKey, string> = {
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "pws.headersConfigured": "该提供方已配置自定义请求头。出于隐私考虑此处不显示具体值。编辑并保存此部分将替换整组请求头。",
  "pws.headersReplaceWarn": "保存将用下方输入内容替换该提供方的全部自定义请求头。",
  "pws.clearHeaders": "清空",
  "pws.removeHeader": "移除请求头",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "modal.userAgent": "自定义 User-Agent",
  "modal.userAgentPlaceholder": "claude-cli/2.1.220 (external, cli)",
  "modal.userAgentHint": "留空则使用默认 User-Agent。",
  "modal.customHeaders": "自定义请求头",
  "modal.customHeadersHint": "添加发送给该提供方的可选 HTTP 请求头。",
  "modal.headerName": "请求头名称",
  "modal.headerValue": "值",
  "modal.addHeader": "添加",
  "modal.headersInvalid": "保存前请修正自定义请求头（空名称、重复或非法字符）。",
  "modal.headersUserAgentRow": "请将 User-Agent 填入“自定义 User-Agent”字段，而不是作为请求头行。",
  "modal.adding": "正在添加…",
  ...
  "claude.customModel.configFile": "配置文件：{path}",
  "claude.customModel.selectEndpoint": "选择端点",
  "claude.customModel.customUrlOption": "自定义 URL...",
  "claude.customModel.current": "当前",
  "claude.customModel.currentEmpty": "（未在 settings.json 中设置）",
  "claude.customModel.apiKey": "API 密钥",
  "claude.customModel.default": "（默认）",
  "claude.customModel.customKeyOption": "自定义 API 密钥...",
  ...
  "claude.customModel.customOption": "自定义模型选项",
  "claude.customModel.selectModel": "选择模型",
  "claude.customModel.clearValue": "清除值",
  "claude.customModel.saveBtn": "保存到 settings.json",
  "claude.customModel.saving": "正在保存...",
  "claude.customModel.savedSuccess": "模型设置已成功保存到 Claude Code 的 settings.json！",
  "claude.customModel.modalTitle": "为 {target} 选择模型",
  "claude.customModel.searchPlaceholder": "搜索模型（例如：opus, gpt-5, deepseek）...",
  "claude.customModel.noModelsFound": "未找到匹配的模型。",
  ...
  "claudeDesktop.section.general": "通用",
  "claudeDesktop.section.profileIo": "导入 / 导出",
  "claudeDesktop.chatTab": "聊天标签页",
  "claudeDesktop.chatTabDesc": "保持 Claude Desktop 的聊天标签页可见。关闭后应用配置只会保留 Cowork 和 Code。",
  "claudeDesktop.supports1mLabel": "支持 1M 上下文",
  "claudeDesktop.supports1mAuto": "该模型报告了 1M 窗口，因此默认开启。",
  "claudeDesktop.supports1mManual": "只有模型确实接受 1M 窗口时才开启。",
  "claudeDesktop.prefer1mLabel": "默认使用 1M",
  "claudeDesktop.prefer1mDesc": "Claude Desktop 会优先选择该模型的 1M 版本。",
  "claudeDesktop.prefer1mRequires": "请先开启 1M 上下文支持。",
  "claudeDesktop.prefer1mChip": "1M 默认",
  "claudeDesktop.hiddenUnavailable": "已隐藏 {count} 个不可用模型。启用其提供商后即可分配。",
  "claudeDesktop.profileIoHint": "以 JSON 形式在不同机器之间迁移此 Desktop 配置。导入只会载入草稿，仍需保存。",
  ...
  "nav.chat": "聊天",
  "chat.threadLabel": "会话",
  "chat.historyLabel": "聊天历史",
  "chat.newChat": "新建聊天",
  "chat.noHistory": "暂无已保存的聊天。",
  "chat.untitled": "新建聊天",
  "chat.renameLabel": "会话标题",
  "chat.renameSave": "保存标题",
  "chat.renameCancel": "取消",
  "chat.deleteChat": "删除聊天",
  "chat.clearAll": "清空历史",
  "chat.clearAllConfirm": "删除所有聊天",
  "chat.model": "模型",
  "chat.loadingModels": "正在加载模型",
  "chat.modelsLoadFailed": "无法加载模型列表",
  "chat.retry": "重试",
  "chat.noModels": "没有可用模型。请先添加提供方或启用模型。",
  "chat.systemPrompt": "系统提示词",
  "chat.systemPromptLabel": "本次会话的系统提示词",
  "chat.systemPromptPlaceholder": "可选指令，将在每轮请求前发送。",
  "chat.emptyTitle": "开始对话",
  "chat.emptyBody": "简洁的对话界面，可与已连接供应商的任意 AI 模型交谈。选个模型就能开始。",
  "chat.roleYou": "你",
  ...
  "chat.deleteFromHere": "从此处删除",
  "chat.dismissError": "关闭",
  "chat.placeholder": "发送消息…",
  "chat.noModelPlaceholder": "请选择要聊天的模型",
  "chat.inputLabel": "消息",
  "chat.send": "发送",
  "chat.stop": "停止",
  "chat.sendHint": "Enter 发送 · Shift+Enter 换行 · 可粘贴或拖入图片与文本文件",
  "chat.attach": "附加文件",
  "chat.attachTextOnlyHint": "附加文本文件（该模型无法读取图片）",
  "chat.removeAttachment": "移除 {name}",
  "chat.attachUnsupported": "{name}：不支持的文件类型",
  "chat.attachTooLarge": "{name}：超过 {limit}",
  "chat.attachTooMany": "每条消息最多 {limit} 个附件",
  "chat.attachReadFailed": "{name}：无法读取",

  "chat.history": "历史",
  "chat.recentChats": "最近对话",
  "chat.emptyChat": "空对话",
  "chat.noModelSelected": "选择模型",
  "chat.modelsPanelTitle": "模型",
  "chat.modelsPanelSub": "仅来自已连接的供应商",
  "chat.modelSearchPlaceholder": "搜索模型或供应商…",
  "chat.modelSearchEmpty": "没有匹配的模型。",
  "chat.modelsFilteredNote": "模型列表根据已连接的供应商筛选。",
  "chat.modeLabel": "回复模式",
  "chat.modeChat": "对话",
  "chat.modeImage": "图像",
  "chat.modeImageSoon": "此页签暂不支持图像生成。",
  "chat.effortLabel": "思考强度",
  "chat.effortNone": "不思考",
  "chat.effortLow": "低",
  "chat.effortMedium": "中",
  "chat.effortHigh": "高",
