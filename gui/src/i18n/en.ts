...
export const en = {
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.headersConfigured": "Custom headers are already configured on this provider. Values are not shown here for privacy. Editing and saving this section replaces the full set.",
  "pws.headersReplaceWarn": "Saving will replace all custom headers on this provider with what you enter below.",
  "pws.clearHeaders": "Clear",
  "pws.removeHeader": "Remove header",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "modal.userAgent": "Custom User-Agent",
  "modal.userAgentPlaceholder": "claude-cli/2.1.220 (external, cli)",
  "modal.userAgentHint": "Leave blank to use the default User-Agent.",
  "modal.customHeaders": "Custom Headers",
  "modal.customHeadersHint": "Add optional HTTP headers sent to this provider.",
  "modal.headerName": "Header name",
  "modal.headerValue": "Value",
  "modal.addHeader": "Add",
  "modal.headersInvalid": "Fix custom headers before saving (empty names, duplicates, or invalid characters).",
  "modal.headersUserAgentRow": "Put User-Agent in the Custom User-Agent field, not as a header row.",
  "modal.adding": "Adding…",
  ...
  "claude.customModel.configFile": "Config file: {path}",
  "claude.customModel.selectEndpoint": "Select Endpoint",
  "claude.customModel.customUrlOption": "Custom URL...",
  "claude.customModel.current": "Current",
  "claude.customModel.currentEmpty": "(Not set in settings.json)",
  "claude.customModel.apiKey": "API Key",
  "claude.customModel.default": "(Default)",
  "claude.customModel.customKeyOption": "Custom API key...",
  "claude.customModel.apiKeyPlaceholder": "sk-... or opencodex-proxy",
  ...
  "claude.customModel.customOption": "Custom Model Option",
  "claude.customModel.selectModel": "Select Model",
  "claude.customModel.clearValue": "Clear value",
  "claude.customModel.saveBtn": "Save to settings.json",
  "claude.customModel.saving": "Saving...",
  "claude.customModel.savedSuccess": "Saved model settings to Claude Code settings.json successfully!",
  "claude.customModel.modalTitle": "Select model for {target}",
  "claude.customModel.searchPlaceholder": "Search models (e.g. opus, gpt-5, deepseek)...",
  "claude.customModel.noModelsFound": "No matching models found.",
  ...
  "claude.quickstart": "How to setup",
  ...
  "chat.historyLabel": "Chat history",
  "chat.newChat": "New chat",
  "chat.noHistory": "No saved chats yet.",
  "chat.untitled": "New chat",
  "chat.renameLabel": "Conversation title",
  "chat.renameSave": "Save title",
  "chat.renameCancel": "Cancel",
  "chat.deleteChat": "Delete chat",
  "chat.clearAll": "Clear history",
  "chat.clearAllConfirm": "Delete all chats",
  "chat.model": "Model",
  "chat.loadingModels": "Loading models",
  "chat.modelsLoadFailed": "Could not load the model list",
  "chat.retry": "Retry",
  "chat.noModels": "No models are available. Add a provider or enable a model first.",
  "chat.systemPrompt": "System prompt",
  "chat.systemPromptLabel": "System prompt for this conversation",
  "chat.systemPromptPlaceholder": "Optional instructions sent before every turn.",
  "chat.emptyTitle": "Start a conversation",
  "chat.emptyBody": "Simple chat interface to interact with any AI model from connected providers. Select a model and start chatting!",
  "chat.roleYou": "You",
  "chat.roleAssistant": "Assistant",
  "chat.thinking": "Thinking",
  "chat.stoppedFlag": "stopped",
  "chat.copyMessage": "Copy message",
  "chat.copyCode": "Copy code",
  "chat.regenerate": "Regenerate",
  "chat.deleteFromHere": "Delete from here",
  "chat.dismissError": "Dismiss",
  "chat.placeholder": "Send a message…",
  "chat.noModelPlaceholder": "Select a model to start chatting",
  "chat.inputLabel": "Message",
  "chat.send": "Send",
  "chat.stop": "Stop",
  "chat.sendHint": "Enter sends · Shift+Enter for a new line · paste or drop images and text files",
  "chat.attach": "Attach files",
  "chat.attachTextOnlyHint": "Attach text files (this model does not read images)",
  "chat.removeAttachment": "Remove {name}",
  "chat.attachUnsupported": "{name}: unsupported file type",
  "chat.attachTooLarge": "{name}: larger than {limit}",
  "chat.attachTooMany": "At most {limit} attachments per message",
  "chat.attachReadFailed": "{name}: could not be read",

  "chat.history": "History",
  "chat.recentChats": "Recent chats",
  "chat.emptyChat": "Empty chat",
  "chat.noModelSelected": "Select a model",
  "chat.modelsPanelTitle": "Models",
  "chat.modelsPanelSub": "Only from connected providers",
  "chat.modelSearchPlaceholder": "Search model or provider…",
  "chat.modelSearchEmpty": "No model matches that search.",
  "chat.modelsFilteredNote": "Model list is filtered from connected providers.",
  "chat.modeLabel": "Response mode",
  "chat.modeChat": "Chat",
  "chat.modeImage": "Image",
  "chat.modeImageSoon": "Image generation is not available in this tab yet.",
  "chat.effortLabel": "Thinking effort",
  "chat.effortNone": "No thinking",
  "chat.effortLow": "Low",
  "chat.effortMedium": "Medium",
  "chat.effortHigh": "High",
  "chat.effortXhigh": "Extra high",
  "chat.effortMax": "Max",
