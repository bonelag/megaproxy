...
export const de: Record<TKey, string> = {
  ...
  "pws.fetchModels": "Modelle abrufen",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.headersConfigured": "Für diesen Anbieter sind bereits benutzerdefinierte Header konfiguriert. Werte werden hier aus Datenschutzgründen nicht angezeigt. Bearbeiten und Speichern ersetzt den gesamten Satz.",
  "pws.headersReplaceWarn": "Speichern ersetzt alle benutzerdefinierten Header dieses Anbieters durch die unten eingegebenen.",
  "pws.clearHeaders": "Leeren",
  "pws.removeHeader": "Header entfernen",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "modal.userAgent": "Benutzerdefinierter User-Agent",
  "modal.userAgentPlaceholder": "claude-cli/2.1.220 (external, cli)",
  "modal.userAgentHint": "Leer lassen, um den Standard-User-Agent zu verwenden.",
  "modal.customHeaders": "Benutzerdefinierte Header",
  "modal.customHeadersHint": "Optionale HTTP-Header, die an diesen Anbieter gesendet werden.",
  "modal.headerName": "Header-Name",
  "modal.headerValue": "Wert",
  "modal.addHeader": "Hinzufügen",
  "modal.headersInvalid": "Korrigiere die benutzerdefinierten Header vor dem Speichern (leere Namen, Duplikate oder ungültige Zeichen).",
  "modal.headersUserAgentRow": "Setze den User-Agent im Feld „Benutzerdefinierter User-Agent“, nicht als Header-Zeile.",
  ...
  "claude.workspace.models": "Modelle",
  "claude.customModel.configFile": "Konfigurationsdatei: {path}",
  "claude.customModel.selectEndpoint": "Endpunkt auswählen",
  "claude.customModel.customUrlOption": "Benutzerdefinierte URL...",
  "claude.customModel.current": "Aktuell",
  "claude.customModel.currentEmpty": "(Nicht in settings.json festgelegt)",
  "claude.customModel.apiKey": "API-Schlüssel",
  "claude.customModel.default": "(Standard)",
  "claude.customModel.customKeyOption": "Benutzerdefinierter API-Schlüssel...",
  "claude.customModel.apiKeyPlaceholder": "sk-... oder opencodex-proxy",
  ...
  "claude.customModel.customOption": "Benutzerdefinierte Modelloption",
  "claude.customModel.selectModel": "Modell auswählen",
  "claude.customModel.clearValue": "Wert löschen",
  "claude.customModel.saveBtn": "In settings.json speichern",
  "claude.customModel.saving": "Speichern...",
  "claude.customModel.savedSuccess": "Modelleinstellungen erfolgreich in settings.json von Claude Code gespeichert!",
  "claude.customModel.modalTitle": "Modell für {target} auswählen",
  "claude.customModel.searchPlaceholder": "Modelle suchen (z. B. opus, gpt-5, deepseek)...",
  "claude.customModel.noModelsFound": "Keine passenden Modelle gefunden.",
  ...
  "claudeDesktop.section.general": "Allgemein",
  "claudeDesktop.section.profileIo": "Import / Export",
  "claudeDesktop.chatTab": "Chat-Tab",
  "claudeDesktop.chatTabDesc": "Den Chat-Tab in Claude Desktop sichtbar halten. Ausgeschaltet bleiben nach dem Anwenden nur Cowork und Code.",
  "claudeDesktop.supports1mLabel": "1M-Kontext-Unterstützung",
  "claudeDesktop.supports1mAuto": "Dieses Modell meldet ein 1M-Fenster, daher ist die Unterstützung standardmäßig an.",
  "claudeDesktop.supports1mManual": "Nur einschalten, wenn das Modell wirklich ein 1M-Fenster annimmt.",
  "claudeDesktop.prefer1mLabel": "Standardmäßig 1M verwenden",
  "claudeDesktop.prefer1mDesc": "Claude Desktop wählt zuerst die 1M-Variante dieses Modells.",
  "claudeDesktop.prefer1mRequires": "Schalte zuerst die 1M-Kontext-Unterstützung ein.",
  "claudeDesktop.prefer1mChip": "1M-Standard",
  "claudeDesktop.hiddenUnavailable": "{count} nicht verfügbares Modell ausgeblendet. Aktiviere seinen Provider, um es zuzuweisen.",
  "claudeDesktop.profileIoHint": "Dieses Desktop-Profil als JSON zwischen Rechnern übertragen. Der Import lädt einen Entwurf, den du noch speichern musst.",
  ...
  // Chat tab
  "nav.chat": "Chat",
  "chat.threadLabel": "Unterhaltung",
  "chat.historyLabel": "Chat-Verlauf",
  "chat.newChat": "Neuer Chat",
  "chat.noHistory": "Noch keine gespeicherten Chats.",
  "chat.untitled": "Neuer Chat",
  "chat.renameLabel": "Titel der Unterhaltung",
  "chat.renameSave": "Titel speichern",
  "chat.renameCancel": "Abbrechen",
  "chat.deleteChat": "Chat löschen",
  "chat.clearAll": "Verlauf löschen",
  "chat.clearAllConfirm": "Alle Chats löschen",
  "chat.model": "Modell",
  "chat.loadingModels": "Modelle werden geladen",
  "chat.modelsLoadFailed": "Modellliste konnte nicht geladen werden",
  "chat.retry": "Erneut versuchen",
  "chat.noModels": "Keine Modelle verfügbar. Füge zuerst einen Anbieter hinzu oder aktiviere ein Modell.",
  "chat.systemPrompt": "System-Prompt",
  "chat.systemPromptLabel": "System-Prompt für diese Unterhaltung",
  "chat.systemPromptPlaceholder": "Optionale Anweisungen, die vor jedem Turn gesendet werden.",
  "chat.emptyTitle": "Unterhaltung beginnen",
  "chat.emptyBody": "Einfache Chat-Oberfläche für jedes KI-Modell verbundener Anbieter. Modell wählen und losschreiben!",
  "chat.roleYou": "Du",
  "chat.roleAssistant": "Assistent",
  "chat.thinking": "Denkt nach",
  "chat.stoppedFlag": "gestoppt",
  "chat.copyMessage": "Nachricht kopieren",
  "chat.copyCode": "Code kopieren",
  "chat.regenerate": "Neu generieren",
  "chat.deleteFromHere": "Ab hier löschen",
  "chat.dismissError": "Ausblenden",
  "chat.placeholder": "Nachricht senden…",
  "chat.noModelPlaceholder": "Wähle ein Modell, um zu chatten",
  "chat.inputLabel": "Nachricht",
  "chat.send": "Senden",
  "chat.stop": "Stoppen",
  "chat.sendHint": "Enter sendet · Shift+Enter für eine neue Zeile · Bilder und Textdateien einfügen oder hierher ziehen",
  "chat.attach": "Dateien anhängen",
  "chat.attachTextOnlyHint": "Textdateien anhängen (dieses Modell liest keine Bilder)",
  "chat.removeAttachment": "{name} entfernen",
  "chat.attachUnsupported": "{name}: nicht unterstützter Dateityp",
  "chat.attachTooLarge": "{name}: größer als {limit}",
  "chat.attachTooMany": "Höchstens {limit} Anhänge pro Nachricht",
  "chat.attachReadFailed": "{name}: konnte nicht gelesen werden",

  "chat.history": "Verlauf",
  "chat.recentChats": "Letzte Chats",
  "chat.emptyChat": "Leerer Chat",
  "chat.noModelSelected": "Modell wählen",
  "chat.modelsPanelTitle": "Modelle",
  "chat.modelsPanelSub": "Nur von verbundenen Anbietern",
  "chat.modelSearchPlaceholder": "Modell oder Anbieter suchen…",
  "chat.modelSearchEmpty": "Kein Modell passt zu dieser Suche.",
  "chat.modelsFilteredNote": "Die Modellliste stammt aus den verbundenen Anbietern.",
  "chat.modeLabel": "Antwortmodus",
  "chat.modeChat": "Chat",
  "chat.modeImage": "Bild",
  "chat.modeImageSoon": "Bildgenerierung ist in diesem Tab noch nicht verfügbar.",
  "chat.effortLabel": "Denktiefe",
  "chat.effortNone": "Kein Denken",
  "chat.effortLow": "Niedrig",
  "chat.effortMedium": "Mittel",
  "chat.effortHigh": "Hoch",
  "chat.effortXhigh": "Sehr hoch",
  "chat.effortMax": "Maximal",
  "chat.thinkingNow": "Denkt nach…",
