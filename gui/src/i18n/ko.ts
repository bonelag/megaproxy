...
export const ko: Record<TKey, string> = {
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.headersConfigured": "이 프로바이더에는 이미 사용자 지정 헤더가 설정되어 있습니다. 개인정보 보호를 위해 값은 표시되지 않습니다. 이 섹션을 편집해 저장하면 전체 세트가 교체됩니다.",
  "pws.headersReplaceWarn": "저장하면 이 프로바이더의 모든 사용자 지정 헤더가 아래 입력 내용으로 교체됩니다.",
  "pws.clearHeaders": "지우기",
  "pws.removeHeader": "헤더 제거",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "modal.userAgent": "사용자 지정 User-Agent",
  "modal.userAgentPlaceholder": "claude-cli/2.1.220 (external, cli)",
  "modal.userAgentHint": "비워 두면 기본 User-Agent를 사용합니다.",
  "modal.customHeaders": "사용자 지정 헤더",
  "modal.customHeadersHint": "이 프로바이더로 보낼 선택적 HTTP 헤더를 추가합니다.",
  "modal.headerName": "헤더 이름",
  "modal.headerValue": "값",
  "modal.addHeader": "추가",
  "modal.headersInvalid": "저장 전에 사용자 지정 헤더를 수정하세요(빈 이름, 중복 또는 잘못된 문자).",
  "modal.headersUserAgentRow": "User-Agent는 헤더 행이 아니라 사용자 지정 User-Agent 필드에 넣으세요.",
  "modal.adding": "추가 중…",
  ...
  "claude.workspace.models": "모델",
  "claude.customModel.configFile": "설정 파일: {path}",
  "claude.customModel.selectEndpoint": "엔드포인트 선택",
  "claude.customModel.customUrlOption": "사용자 지정 URL...",
  "claude.customModel.current": "현재",
  "claude.customModel.currentEmpty": "(settings.json에 설정되지 않음)",
  "claude.customModel.apiKey": "API 키",
  "claude.customModel.default": "(기본값)",
  "claude.customModel.customKeyOption": "사용자 지정 API 키...",
  "claude.customModel.apiKeyPlaceholder": "sk-... 또는 opencodex-proxy",
  ...
  "claude.customModel.customOption": "사용자 지정 모델 옵션",
  "claude.customModel.selectModel": "모델 선택",
  "claude.customModel.clearValue": "값 지우기",
  "claude.customModel.saveBtn": "settings.json에 저장",
  "claude.customModel.saving": "저장 중...",
  "claude.customModel.savedSuccess": "Claude Code의 settings.json에 모델 설정을 성공적으로 저장했습니다!",
  "claude.customModel.modalTitle": "{target}용 모델 선택",
  "claude.customModel.searchPlaceholder": "모델 검색 (예: opus, gpt-5, deepseek)...",
  "claude.customModel.noModelsFound": "일치하는 모델이 없습니다.",
  ...
  "nav.chat": "채팅",
  "chat.threadLabel": "대화",
  "chat.historyLabel": "채팅 기록",
  "chat.newChat": "새 채팅",
  "chat.noHistory": "저장된 채팅이 없습니다.",
  "chat.untitled": "새 채팅",
  "chat.renameLabel": "대화 제목",
  "chat.renameSave": "제목 저장",
  "chat.renameCancel": "취소",
  "chat.deleteChat": "채팅 삭제",
  "chat.clearAll": "기록 지우기",
  "chat.clearAllConfirm": "모든 채팅 삭제",
  "chat.model": "모델",
  "chat.loadingModels": "모델 불러오는 중",
  "chat.modelsLoadFailed": "모델 목록을 불러올 수 없습니다",
  "chat.retry": "다시 시도",
  "chat.noModels": "사용할 수 있는 모델이 없습니다. 먼저 공급자를 추가하거나 모델을 활성화하세요.",
  "chat.systemPrompt": "시스템 프롬프트",
  "chat.systemPromptLabel": "이 대화의 시스템 프롬프트",
  "chat.systemPromptPlaceholder": "매 턴 전에 전송되는 선택적 지시문입니다.",
  "chat.emptyTitle": "대화 시작",
  "chat.emptyBody": "연결된 제공자의 모든 AI 모델과 대화할 수 있는 간단한 채팅 화면입니다. 모델을 골라 시작하세요.",
  "chat.roleYou": "나",
  "chat.roleAssistant": "어시스턴트",
  "chat.thinking": "생각 중",
  "chat.stoppedFlag": "중단됨",
  "chat.copyMessage": "메시지 복사",
  "chat.copyCode": "코드 복사",
  "chat.regenerate": "다시 생성",
  "chat.deleteFromHere": "여기서부터 삭제",
  "chat.dismissError": "닫기",
  "chat.placeholder": "메시지 보내기…",
  "chat.noModelPlaceholder": "채팅할 모델을 선택하세요",
  "chat.inputLabel": "메시지",
  "chat.send": "보내기",
  "chat.stop": "중지",
  "chat.sendHint": "Enter로 전송 · Shift+Enter로 줄바꿈 · 이미지와 텍스트 파일을 붙여넣거나 끌어다 놓을 수 있습니다",
  "chat.attach": "파일 첨부",
  "chat.attachTextOnlyHint": "텍스트 파일 첨부 (이 모델은 이미지를 읽지 못합니다)",
  "chat.removeAttachment": "{name} 제거",
  "chat.attachUnsupported": "{name}: 지원하지 않는 파일 형식",
  "chat.attachTooLarge": "{name}: {limit}보다 큽니다",
  "chat.attachTooMany": "메시지당 최대 {limit}개의 첨부만 가능합니다",
  "chat.attachReadFailed": "{name}: 읽을 수 없습니다",

  "chat.history": "기록",
  "chat.recentChats": "최근 대화",
  "chat.emptyChat": "빈 대화",
  "chat.noModelSelected": "모델 선택",
  "chat.modelsPanelTitle": "모델",
  "chat.modelsPanelSub": "연결된 제공자만 해당",
  "chat.modelSearchPlaceholder": "모델 또는 제공자 검색…",
  "chat.modelSearchEmpty": "조건에 맞는 모델이 없습니다.",
  "chat.modelsFilteredNote": "모델 목록은 연결된 제공자로 필터링됩니다.",
  "chat.modeLabel": "생성 모드",
  "chat.modeChat": "채팅",
  "chat.modeImage": "이미지",
  "chat.modeImageSoon": "이 탭에서는 아직 이미지 생성을 사용할 수 없습니다.",
  "chat.effortLabel": "생각 강도",
  "chat.effortNone": "생각 없이",
  "chat.effortLow": "낮음",
  "chat.effortMedium": "보통",
  "chat.effortHigh": "높음",
  "chat.effortXhigh": "매우 높음",
  "chat.effortMax": "최대",
  "chat.thinkingNow": "생각 중…",
  "chat.thoughtProcess": "생각 과정",
};
