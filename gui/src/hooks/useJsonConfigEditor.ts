...
export interface Config {
  ...
  providers: Record<string, Record<string, unknown> & { adapter: string; baseUrl: string; hasApiKey?: boolean; hasHeaders?: boolean; headers?: Record<string, string>; xaiResponsesOptInState?: boolean | "mixed" }>;
}
